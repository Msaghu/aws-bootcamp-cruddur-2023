...
docker run --rm \
    ...
    --env AWS_COGNITO_USER_POOL_CLIENT_ID="hggjgdkjfgjkdhkdjshdsjkfhjhdghvbjhbv" \
    -it backend-flask-prod 
```
- Start up the postgres and dynamodb containers and when port ```4567``` for the flask container is open, open in a new tab and add ```/api/activities/home``` i.e
- ```
